        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-8 max-w-3xl mx-auto">
            {[
              ...
              { phase: "Fase 4", title: "Lanzamiento en Argentina", status: "Planificado", desc: "Lanzamiento inicial en las principales ciudades de Argentina: Buenos Aires, Córdoba, Rosario y Mendoza. Expansión gradual a todo el territorio nacional.", active: false },
            ].map((item, i) => (
