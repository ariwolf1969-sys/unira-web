        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-8 max-w-3xl mx-auto">
            {[
              ...
              { phase: "Fase 2", title: "Constitución legal y financiamiento", status: "Próximamente", desc: "Una vez alcanzada la meta de socios, procederemos con la constitución legal de la cooperativa bajo las leyes argentinas, la apertura de cuentas bancarias y la búsqueda del financiamiento de $700 millones de pesos.", active: false },
