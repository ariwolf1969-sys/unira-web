      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-muted text-xs">&copy; {new Date().getFullYear()} Unira. Todos los derechos reservados.</p>
            {visits !== null && <p className="text-muted/50 text-xs mt-1">{visits} visitas al sitio</p>}
          <div className="flex items-center gap-4">
            ...
            <a href="https://www.instagram.com/cooperativa_unira/" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-primary transition-colors" aria-label="Instagram">
